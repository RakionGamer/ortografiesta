...
const oracionesCompletar = [
    {
        oracion: "_aria y pedro van a madrid.",
        opciones: ["M", "m"],
        correctas: ["M"],
        pista: "Nombres de personas y lugares",
    },
    {
        oracion: "el _ío ebro pasa por seville.",
        opciones: ["R", "r"],
        correctas: ["r"],
        pista: "Río es común, pero Ebro y Sevilla son propios",
    },
    {
        oracion: "_oy es lunes. viene a visitarme.",
        opciones: ["H", "h"],
        correctas: ["H"],
        pista: "Inicio de oración y después de punto",
    },
    {
        oracion: "mi _erro se llama toby.",
        opciones: ["P", "p"],
        correctas: ["p"],
        pista: "Perro es común, Toby es nombre propio",
    },
    {
        oracion: "_stamos en diciembre. Hace mucho frío.",
        opciones: ["E", "e"],
        correctas: ["E"],
        pista: "Inicio de oración y después de punto",
    },
    {
        oracion: "el _lanet tierra es azul.",
        opciones: ["P", "p"],
        correctas: ["p"],
        pista: "Planeta es común, Tierra es nombre propio",
    },
    {
        oracion: "_éxico está en América. Es un país hermoso.",
        opciones: ["M", "m"],
        correctas: ["M"],
        pista: "Países y continentes son nombres propios",
    },
    {
        oracion: "la _aestra María enseña matemáticas.",
        opciones: ["M", "m"],
        correctas: ["m"],
        pista: "Maestra es común, María es nombre propio",
    },
    {
        oracion: "_l sol sale por el Este.",
        opciones: ["E", "e"],
        correctas: ["E"],
        pista: "Inicio de oración, sol es común, este es dirección",
    },
    {
        oracion: "¿_ónde vives? vivo en Barcelona.",
        opciones: ["D", "d"],
        correctas: ["D"],
                            ...
                            <div className="max-w-4xl mx-auto">
                                {!actividadCompletada ? (
                                    <div className="space-y-8">
                                                ...
                                                <div className="text-center">
                                                    <div className="text-3xl md:text-4xl font-bold text-purple-800 leading-relaxed tracking-wide">
                                                        {mostrarResultado === true ? 
                                                            // Show complete sentence when correct
                                                            oracionesCompletar[preguntaActual].oracion.replace('_', oracionesCompletar[preguntaActual].correctas[0])
                                                            :
                                                            // Show original sentence with blank
                                        ...
                                        {/* Complete sentence display when correct - NEW SECTION */}
                                        {mostrarResultado === true && (
                                            <div className="flex justify-center">
                                                <div className="bg-gradient-to-r from-green-100 to-emerald-100 border-2 border-green-300 rounded-2xl p-6 max-w-2xl mx-auto shadow-lg transform animate-in slide-in-from-bottom-4 duration-700">
                                                    <div className="flex items-center gap-3 mb-3">
                                                        <div className="w-8 h-8 bg-gradient-to-r from-green-400 to-emerald-400 rounded-full flex items-center justify-center">
                                                            ✓
                                                        </div>
                                                        <h3 className="text-lg font-semibold text-green-800">Oración completa:</h3>
                                                    </div>
                                                    <p className="text-2xl font-bold text-green-700 leading-relaxed text-center">
                                                        {oracionesCompletar[preguntaActual].oracion.replace('_', oracionesCompletar[preguntaActual].correctas[0])}
                                                    </p>
                                                </div>
                                            </div>
